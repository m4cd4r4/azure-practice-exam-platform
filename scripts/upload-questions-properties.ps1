# Script to upload questions using individual property assignments
...
# Function to upload a single question using individual properties
function Upload-Question {
    ...
    try {
        ...
        # Use individual property assignments
